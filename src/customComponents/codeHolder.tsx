...
export default function CodeHolder({ code, handleSheetClose}: codeHolderProps) {
  ...
  return (
    ...
    className='flex flex-row bg-accent w-full max-h-screen overflow-y-scroll bg-opacity-40 z-50 '>
    
      <div className="h-full w-full dark:bg-gray-800 rounded-lg shadow-xl overflow-hidden flex flex-col">
        {/* Header */}
